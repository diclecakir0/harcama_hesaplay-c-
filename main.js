...
function addExpense(e){
	...
	if (!harcamaInput.value || !fiyatInput.value){
		alert('Formları Doldur');
		return; // return diyerek alttaki kodu okumamasınıbelirtiyoruz. yani fonksiyonu durduruyoruz.
	}
	...
	<div class="buttons">
	  <img id="payment" src="/images/pey.png" alt="" />
...
// listeye tıklama olayını yönetme
